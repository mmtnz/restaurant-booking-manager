...
layout = html.Div(children=[
    ...
    dbc.Row(
        dbc.Col(
            dbc.Tabs(
                [
                    dbc.Tab(tab_month, label="Month statics"),
                    dbc.Tab(tab_week, label="Week statics"),
                ],
                className="statics-tab"
            ),
            width={"offset": 2}
        )
    ),
...
dash.register_page(os.path.basename(__file__), name='Statics', path="/statics", layout=layout)
